                    ...
                    <div class="card">
                        <div class="card-header" style="padding:0.50rem 1.25rem 0 1.25rem">
                            <div class="d-flex justify-content-start w-100">
                                <a href="<?= base_url('admin/pegawai'); ?>" class="btn btn-info" style="display: block; text-align: left; margin: 0; padding: 10px; background-color: transparent; border: none; color: #3468C0; "><i class="fa-solid fa-chevron-left"></i><span style="margin-left: 20px">Kembali</span></a>
                            </div>
                        </div>
